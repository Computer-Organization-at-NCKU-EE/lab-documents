...
We take ADD and SUB instructions as examples at here.
...
As what we stated in @sec-iss-predefine, we can now implement the execution logic by simply using `switch-case` statement with the power of `inst_enum_t`, which is simple and straightforward.
