...
>
> ![The operation of the **while** loop in lines 8-18 in the call `MERGE(A, 9, 12, 16)`, when the subarray `A[9:16]` contains the values `<2, 4, 6, 7, 1, 2, 3, 5>`.](images/merge.png){align="center" width=80%}
>
> ![The operation of merge sort on the array A with length 8 that initially contains the sequence `<12, 3, 7, 9, 14, 6, 11, 2>`.](images/merge-sort.png){width=50% align="center"}
>
...
2. Why does calling convention matter? Please use an example to explain it.
3. ...
4. ...
5. ...
