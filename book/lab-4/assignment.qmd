...
- Hence, the main problem is how to extend the existed framework we have done in Lab 3 to address the synchronization problem between C model and RTL model