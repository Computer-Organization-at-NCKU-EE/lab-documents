...
![CPU Block Diagram](images/.png){width=100% fig-align="center"}
...
is_D_rs1_E_rd_overlap = is_D_use_rs1 & is_E_use_rd & E_rd != 0
is_D_use_rs1 = ?

is_D_rs2_E_rd_overlap = is_D_use_rs2 & is_E_use_rd & E_rd != 0
is_D_use_rs2 = ?
```
