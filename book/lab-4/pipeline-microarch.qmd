...
- Top.v
    ...
    - MUX2.sv 
    - MUX3.sv 
    - Controller.sv (**you need to complete**)
    - Reg_PC.sv 
    - Reg_D.sv  (**you need to complete**)
    - Reg_E.sv  (**you need to complete**)
    - Reg_M.sv  (**you need to complete**)
    - Reg_W.sv  (**you need to complete**)
    - ROM.sv
    - RAM.sv
    - TextBuffer.sv
    - Halt.sv
...
1. Compile
   ...
   ```{.bash}
   $ cd <your lab-4 directory>
   $ mkdir build # do only once
   $ cd build
   $ cmake ..
   $ make -j
   ```
