...
- The micro-architecture of a classic five stages pipeline CPU
  ...
  The latency caused by inserting the register is ignored here. A more detailed explanation of how to calculate the impact of latency will be provided later.
...
- Control Hazard
  ...
  Branch prediction is also a form of control hazard. In Lab 4 we’ll introduce only the concept later.
  
  There is no specific solution. In the Lab 4 report, you will be asked to briefly describe how you would design the control signals to resolve this hazard. 
  :::
...
- Data Hazard
  ...
  ::: {.callout-note}
  In essence, anti-dependencies and output dependencies stem from the ISA’s limited set of architectural registers. By providing more physical registers and using register renaming, we can eliminate these constraints and enable out-of-order execution.
  :::
